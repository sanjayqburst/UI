...
@Parcelize
data class NewsInfo(var id:Int,var image:Int,var briefDesc:String,var fav:Boolean,var time:String,var content:String):Parcelable



val item1=NewsInfo(1,R.drawable.newsimg,
...
val item2= item1.copy(id = 2,fav = false, time ="12:00PM, 12 Nov, 2021" )
val item3= item1.copy(id = 3,fav = false, time = "11:50AM, 24 Nov, 2021")
val item4= item1.copy(id=4,time ="12:00PM, 12 Nov, 2021" )
